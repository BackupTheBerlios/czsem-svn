...
Figure~\ref{img:ExtractionProcessIntro} learning and annotation process in general (ILP version later, Section~\ref{sec:methods_learning})
...
Formal definitions of ILP tasks are presented in following sections. They will be extended and used for implementation of Fuzzy ILP Classifier, see details in Section~\ref{sec:methods_fuzzy}.
