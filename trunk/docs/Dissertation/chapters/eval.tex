...
In Figure~\ref{fig:learning_eval_rules} we present some examples of the rules learned from the whole dataset. The rules demonstrate a connection of a target token with other parts of a sentence through linguistic syntax structures. For example the first rule connects a root numeral (\emph{n.quant.def}) of `damage' with a mention of `investigator' that stated the mount. In the last rule only a positive occurrence of the verb `injure' is allowed.
...
\hline
            damage &&      0.913 &  $\pm$  &       0.160 & &      0.853 &  $\pm$  &       0.193 & $\bullet$ \\
       end subtree &&      0.689 &  $\pm$  &       0.317 & &      0.510 &  $\pm$  &       0.210 & $\bullet$ \\
             start &&      0.936 &  $\pm$  &       0.103 & &      0.654 &  $\pm$  &       0.117 & $\bullet$ \\
          injuries &&      0.559 &  $\pm$  &       0.325 & &      0.394 &  $\pm$  &       0.268 & $\bullet$ \\
        fatalities &&      0.863 &  $\pm$  &       0.335 & &      0.347 &  $\pm$  &       0.401 & $\bullet$ \\
  profesional unit &&      0.500 &  $\pm$  &       0.189 & &      0.674 &  $\pm$  &       0.132 & $\circ$ \\
      amateur unit &&      0.805 &  $\pm$  &       0.300 & &      0.601 &  $\pm$  &       0.297 & $\bullet$ \\
\hline
          overall &&      0.752 &  $\pm$  &       0.306 & &      0.576 &  $\pm$  &       0.296 & $\bullet$ \\
\hline
\\
...
Task && \multicolumn{3}{c}{ILP}  && \multicolumn{3}{c}{PAUM} && \\
\hline
            damage &&      0.817 &  $\pm$  &       0.258 & &      0.904 &  $\pm$  &       0.188 & $\circ$ \\
       end subtree &&      0.254 &  $\pm$  &       0.214 & &      0.623 &  $\pm$  &       0.226 & $\circ$ \\
             start &&      0.896 &  $\pm$  &       0.130 & &      0.980 &  $\pm$  &       0.061 & $\circ$ \\
          injuries &&      0.540 &  $\pm$  &       0.322 & &      0.801 &  $\pm$  &       0.242 & $\circ$ \\
        fatalities &&      0.417 &  $\pm$  &       0.451 & &      0.567 &  $\pm$  &       0.452 & $\circ$ \\
  profesional unit &&      0.500 &  $\pm$  &       0.152 & &      0.814 &  $\pm$  &       0.156 & $\circ$ \\
      amateur unit &&      0.845 &  $\pm$  &       0.272 & &      0.932 &  $\pm$  &       0.136 & $\circ$ \\
\hline
          overall &&      0.610 &  $\pm$  &       0.357 & &      0.803 &  $\pm$  &       0.277 & $\circ$ \\
\hline
\\
...
Task && \multicolumn{3}{c}{ILP}  && \multicolumn{3}{c}{PAUM} && \\
\hline
            damage &&      0.824 &  $\pm$  &       0.224 & &      0.848 &  $\pm$  &       0.169 &  \\
       end subtree &&      0.312 &  $\pm$  &       0.222 & &      0.541 &  $\pm$  &       0.192 & $\circ$ \\
             start &&      0.909 &  $\pm$  &       0.094 & &      0.779 &  $\pm$  &       0.087 & $\bullet$ \\
          injuries &&      0.484 &  $\pm$  &       0.288 & &      0.470 &  $\pm$  &       0.251 &  \\
        fatalities &&      0.346 &  $\pm$  &       0.431 & &      0.221 &  $\pm$  &       0.309 & $\bullet$ \\
  profesional unit &&      0.488 &  $\pm$  &       0.154 & &      0.730 &  $\pm$  &       0.126 & $\circ$ \\
      amateur unit &&      0.759 &  $\pm$  &       0.314 & &      0.675 &  $\pm$  &       0.284 & $\bullet$ \\
\hline
          overall &&      0.589 &  $\pm$  &       0.346 & &      0.609 &  $\pm$  &       0.294 &  \\
\hline
\\
\multicolumn{11}{c}{$\circ$, $\bullet$ statistically significant improvement or degradation}\\
\end{tabular}

\caption{Evaluation on Czech Fireman dataset} \label{tab:learning_fir_eval}
\end{table}
...
Task && \multicolumn{3}{c}{ILP}  && \multicolumn{3}{c}{PAUM} && \\
\hline
            damage &&     0:24.1 &  $\pm$  &      0:06.3 & &     0:02.2 &  $\pm$  &      0:00.1 & $\bullet$ \\
       end subtree &&     1:37.8 &  $\pm$  &      0:14.6 & &     0:02.2 &  $\pm$  &      0:00.1 & $\bullet$ \\
             start &&     0:26.5 &  $\pm$  &      0:04.1 & &     0:02.2 &  $\pm$  &      0:00.1 & $\bullet$ \\
          injuries &&     1:34.9 &  $\pm$  &      0:15.2 & &     0:02.2 &  $\pm$  &      0:00.1 & $\bullet$ \\
        fatalities &&     0:45.5 &  $\pm$  &      0:09.0 & &     0:02.2 &  $\pm$  &      0:00.1 & $\bullet$ \\
  profesional unit &&     2:41.4 &  $\pm$  &      0:24.5 & &     0:02.2 &  $\pm$  &      0:00.1 & $\bullet$ \\
      amateur unit &&     0:25.2 &  $\pm$  &      0:05.2 & &     0:02.2 &  $\pm$  &      0:00.1 & $\bullet$ \\
\hline
          overall &&     1:07.9 &  $\pm$  &      0:50.1 & &     0:02.2 &  $\pm$  &      0:00.1 & $\bullet$ \\
\hline
\\
...
Task && \multicolumn{3}{c}{ILP}  && \multicolumn{3}{c}{PAUM} && \\
\hline
            damage &&     0:00.9 &  $\pm$  &      0:00.2 & &     0:00.3 &  $\pm$  &      0:00.1 & $\bullet$ \\
       end subtree &&     0:00.9 &  $\pm$  &      0:00.2 & &     0:00.3 &  $\pm$  &      0:00.1 & $\bullet$ \\
             start &&     0:00.9 &  $\pm$  &      0:00.1 & &     0:00.3 &  $\pm$  &      0:00.0 & $\bullet$ \\
          injuries &&     0:00.9 &  $\pm$  &      0:00.1 & &     0:00.3 &  $\pm$  &      0:00.0 & $\bullet$ \\
        fatalities &&     0:00.9 &  $\pm$  &      0:00.2 & &     0:00.3 &  $\pm$  &      0:00.1 & $\bullet$ \\
...
\caption{Time spent by ML engines on the Czech Fireman dataset.} \label{tab:learning_fir_time}
\end{table}
