...
But of course we are not satisfied with this fashion of semantic interpretation and we plan to further develop the semantic interpretation step as a sophisticated ``annotation $\rightarrow$ ontology'' transformation process, similarly like it we described for the manually designed rules in Section~\ref{sec:manual_sem_interpret}.
