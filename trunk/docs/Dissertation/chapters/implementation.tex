...
An example of such extraction rule is in Figure~\ref{fig:btred_rule} and corresponding extraction output on Figure~\ref{fig:btred_xml}. TODO: explain
...
\end{minted}
\caption{Document ontology example (RDF serialization of linguistic trees), based on Figure~\ref{fig:intro_damage_tree}}.
