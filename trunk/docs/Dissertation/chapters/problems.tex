...
Both manually annotated datasets described in this thesis are of this kind of event extraction; see details in Sections~\ref{sec:data_fireman_annotated} ans \ref{sec:data_corporate_acquisitions}. 
