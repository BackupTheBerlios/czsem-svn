...
The most closely related work was already presented in Section~\ref{sec:relwork_ext_ont}. The main idea of the chapter will be described in Section~\ref{sec:main}, its implementation in Section~\ref{sec:case} and in Section~\ref{sec:ch70_experiment} an experiment with several OWL reasoners and IE datasets will be presented. In Section~\ref{sec:discuss} related issues are discussed and Section~\ref{sec:ch70_conclusion} concludes the chapter.
