...
%\author{Jan Dedek\inst{1} \and Alan Eckhardt\inst{1,2} \end Peter Vojtas\inst{1,2} \and Leo Galambos\inst{1}}
...
%\begin{figure}
%\centering
%\epsfig{file=img/StructuralSimilarity,  width=\hsize}
