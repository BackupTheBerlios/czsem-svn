...
All the resources (including source codes of the case study and the experiment, datasets and ontologies) mentioned in this paper are publically available on the project's web site\footnote{\url{http://czsem.berlios.de/}} and detailed information can be found there.
...
Four OWL reasoners were used in the experiment
(namely
...
and the time they spent on processing a particular dataset was measured.
