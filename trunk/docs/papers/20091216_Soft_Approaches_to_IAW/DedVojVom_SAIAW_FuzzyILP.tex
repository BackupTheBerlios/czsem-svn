...
\noindent Values of the overall seriousness ranking attribute were stated from ``a general impression'' from texts of the reports texts with respect to particular attributes. %(Fig.~\ref{img:attributes_description}). 
The values have evolved to 14 distinct values in the range form 0.5 to 8. 
...
\begin{itemize}
	\item a crisp hypothesis learned form $E_t$ and $B^{raw}_{T}$ and
	\item a monotonized hypothesis learned form $E_{\ge t}$ and ${B}^{mon}_T$.
\end{itemize}
