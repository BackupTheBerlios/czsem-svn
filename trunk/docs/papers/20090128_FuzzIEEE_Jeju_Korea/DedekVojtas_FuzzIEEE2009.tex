...
Citace Aleph: \\
A Learning Engine for Proposing Hypotheses (Aleph  v5\footnote{\url{http://www.comlab.ox.ac.uk/activities/machinelearning/Aleph/}}) 
...
\caption{Frequency histogram of accidents ranking.}
