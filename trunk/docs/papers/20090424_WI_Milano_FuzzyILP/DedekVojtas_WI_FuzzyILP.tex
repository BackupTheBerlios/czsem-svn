...
\begin{abstract}
In this paper we present a fuzzy system which increases automation of fuzzy classification of textual web reports. Our approach is based on usage of third party linguistic analyzer, our previous work on web information extraction and fuzzy inductive logic programming. Main contributions are formal models, prototype implementation and evaluation of experiments of the fuzzy classification method. 
\end{abstract}
