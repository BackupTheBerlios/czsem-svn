...
\begin{itemize}
	\item Induction of Generalized Annotated Programs is equivalent\footnote{See in S. Krajci, R. Lencses and P. Vojtas: ``A comparison of fuzzy and annotated logic programming'', Fuzzy Sets and Systems, vol.144, pp.173–192, 2004.} to Fuzzy ILP
\end{itemize}
\end{frame}
