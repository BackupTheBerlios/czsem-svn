...
Jejich stažení a automatická anotace probìhlo: 
Mon Aug  6 11:56:25 CEST 2007 -- Mon Aug  6 14:50:49 CEST 2007

Tato data je je možné prohlížet pomocí editoru TreEd a analyzovat pomocí btred makry v adresáøi czsem/src/perl.
...
Adresáøi czsem obsahuje SVN repository z 10.8.2007. Pøed prohlížením jeho obsahu ho prosím aktualizujte.

Postup aktualizace:
1) Zkopírujte tento adresáø na místo, kde bude mužné pøepisovat jeho data.
...
podrobnosti je též možné naléyt v souboru czsem/docs/UserGuide/Install.txt
