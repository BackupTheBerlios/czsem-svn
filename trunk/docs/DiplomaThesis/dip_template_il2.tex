%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%                                    %%%
%%% ©ablona diolomové práce na MFF UK %%%
%%%                                    %%%
...
%%% Následuje první, úvodní, strana diplomové práce. Jednotlivé polo¾ky nahraïte dle vlastních
...
\large
\noindent Vedoucí diplomové práce: Jméno se v¹emi tituly a pracovi¹tì, % doplòte odpovídající údaje
...
\begin{center}
2006 % doplòte rok vzniku va¹í diplomové práce
\end{center}
...
Vedoucí diplomové práce: Jméno se v¹emi tituly, event. pracovi¹tì\\
