  ...
  public static void main(String[] args) {
      ...
      try {
          ...
          ont = manager.loadOntologyFromOntologyDocument(
        		  new File("czsem_GATE_plugins/TmT_serializations/owl/jihomoravsky47443.txt.xml_00034.tmt.owl"));
          System.out.println("Loaded " + ont.getOntologyID());

          ont = manager.loadOntologyFromOntologyDocument(Reasoning.class.getResourceAsStream("PMT2GATE_ontology_utils.owl"));
          System.out.println("Loaded " + ont.getOntologyID());

          ont = manager.loadOntologyFromOntologyDocument(
        		  new File("gate-learning/czech_fireman/rules/learned_rules_test1.owl"));
          System.out.println("Loaded " + ont.getOntologyID());
          
          OWLOntologyMerger merger = new OWLOntologyMerger(manager);
          OWLOntology merged_ont = merger.createMergedOntology(manager, null);
          ...
          OWLReasoner reasoner = reasonerFactory.createReasoner(merged_ont, config);
          ...
          OWLClass vegPizza = fac.getOWLClass(IRI.create("http://czsem.berlios.de/ontologies/PMT2GATE_ontology_utils.owl#MentionRoot"));
          ...
          NodeSet<OWLNamedIndividual> instances = reasoner.getInstances(vegPizza, false);
          ...
          System.out.println("topNode  end");
