...
public class MorceBatchAnalysis
{
	...
	class BatchAnalysisThread extends Thread
	{
		...
		public void run()
		{
			...
			try {
				tmt_ba = (TectoMTBatchAnalyser) new SinglePRSetup(
...
//							,"SCzechW_to_SCzechM::TagMorce"
				...
				corpus = Factory.newCorpus("corpus_"+getName());
	...
	static String inputdir = "C:\\Users\\dedek\\Desktop\\bmc\\filter_include\\";
	static String outputdir = "C:\\Users\\dedek\\Desktop\\bmc\\morce_analyzed\\";
	
	static final int threads = 2;
	int files_in_single_btach = 2;
	...
	public MorceBatchAnalysis(String inputdir)
	{
	...
	public static void main(String[] args) throws URISyntaxException, IOException, GateException
	{
		...
		MorceBatchAnalysis mba = new MorceBatchAnalysis(inputdir); 
